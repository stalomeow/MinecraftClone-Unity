...
namespace XLua.CSObjectWrap
{
    ...
    public class MinecraftScriptableWorldGenerationGenLayersAddBeachLayerWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(Minecraft.ScriptableWorldGeneration.GenLayers.AddBeachLayer);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 3 && LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2) && translator.Assignable<Minecraft.ScriptableWorldGeneration.GenLayers.StatelessGenLayer>(L, 3))
				{
					...
					var gen_ret = new Minecraft.ScriptableWorldGeneration.GenLayers.AddBeachLayer(_seed, _parent);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to Minecraft.ScriptableWorldGeneration.GenLayers.AddBeachLayer constructor!");
        ...
        static int _m_GetInts(RealStatePtr L)
        {
		    try {
                ...
                Minecraft.ScriptableWorldGeneration.GenLayers.AddBeachLayer gen_to_be_invoked = (Minecraft.ScriptableWorldGeneration.GenLayers.AddBeachLayer)translator.FastGetCSObj(L, 1);
