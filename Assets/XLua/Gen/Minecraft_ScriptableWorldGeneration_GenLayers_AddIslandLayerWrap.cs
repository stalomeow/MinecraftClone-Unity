...
namespace XLua.CSObjectWrap
{
    ...
    public class MinecraftScriptableWorldGenerationGenLayersAddIslandLayerWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(Minecraft.ScriptableWorldGeneration.GenLayers.AddIslandLayer);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 3 && LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2) && translator.Assignable<Minecraft.ScriptableWorldGeneration.GenLayers.StatelessGenLayer>(L, 3))
				{
					...
					var gen_ret = new Minecraft.ScriptableWorldGeneration.GenLayers.AddIslandLayer(_seed, _parent);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to Minecraft.ScriptableWorldGeneration.GenLayers.AddIslandLayer constructor!");
        ...
        static int _m_GetInts(RealStatePtr L)
        {
		    try {
                ...
                Minecraft.ScriptableWorldGeneration.GenLayers.AddIslandLayer gen_to_be_invoked = (Minecraft.ScriptableWorldGeneration.GenLayers.AddIslandLayer)translator.FastGetCSObj(L, 1);
