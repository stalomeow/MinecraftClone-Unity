...
namespace XLua.CSObjectWrap
{
    ...
    public class MinecraftScriptableWorldGenerationGenLayersIslandLayerWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(Minecraft.ScriptableWorldGeneration.GenLayers.IslandLayer);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 3 && LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2) && translator.Assignable<Minecraft.ScriptableWorldGeneration.GenLayers.StatelessGenLayer>(L, 3))
				{
					...
					var gen_ret = new Minecraft.ScriptableWorldGeneration.GenLayers.IslandLayer(_seed, _parent);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to Minecraft.ScriptableWorldGeneration.GenLayers.IslandLayer constructor!");
        ...
        static int _m_GetInts(RealStatePtr L)
        {
		    try {
                ...
                Minecraft.ScriptableWorldGeneration.GenLayers.IslandLayer gen_to_be_invoked = (Minecraft.ScriptableWorldGeneration.GenLayers.IslandLayer)translator.FastGetCSObj(L, 1);
