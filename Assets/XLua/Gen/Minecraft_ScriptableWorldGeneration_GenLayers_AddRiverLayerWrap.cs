...
namespace XLua.CSObjectWrap
{
    ...
    public class MinecraftScriptableWorldGenerationGenLayersAddRiverLayerWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(Minecraft.ScriptableWorldGeneration.GenLayers.AddRiverLayer);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 3 && LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2) && translator.Assignable<Minecraft.ScriptableWorldGeneration.GenLayers.StatelessGenLayer>(L, 3))
				{
					...
					var gen_ret = new Minecraft.ScriptableWorldGeneration.GenLayers.AddRiverLayer(_seed, _parent);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to Minecraft.ScriptableWorldGeneration.GenLayers.AddRiverLayer constructor!");
        ...
        static int _m_GetInts(RealStatePtr L)
        {
		    try {
                ...
                Minecraft.ScriptableWorldGeneration.GenLayers.AddRiverLayer gen_to_be_invoked = (Minecraft.ScriptableWorldGeneration.GenLayers.AddRiverLayer)translator.FastGetCSObj(L, 1);
