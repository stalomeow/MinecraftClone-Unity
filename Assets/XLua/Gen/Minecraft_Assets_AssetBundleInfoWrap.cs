...
namespace XLua.CSObjectWrap
{
    ...
    public class MinecraftAssetsAssetBundleInfoWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(Minecraft.Assets.AssetBundleInfo);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					var gen_ret = new Minecraft.Assets.AssetBundleInfo();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to Minecraft.Assets.AssetBundleInfo constructor!");
        ...
        static int _g_get_FileName(RealStatePtr L)
        {
		    try {
                ...
                Minecraft.Assets.AssetBundleInfo gen_to_be_invoked = (Minecraft.Assets.AssetBundleInfo)translator.FastGetCSObj(L, 1);
        ...
        static int _s_set_Dependencies(RealStatePtr L)
        {
		    try {
                ...
                Minecraft.Assets.AssetBundleInfo gen_to_be_invoked = (Minecraft.Assets.AssetBundleInfo)translator.FastGetCSObj(L, 1);
                gen_to_be_invoked.Dependencies = (string[])translator.GetObject(L, 2, typeof(string[]));
