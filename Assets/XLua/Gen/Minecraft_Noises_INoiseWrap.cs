...
namespace XLua.CSObjectWrap
{
    ...
    public class MinecraftNoisesINoiseWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(Minecraft.Noises.INoise);
        ...
        {
            return LuaAPI.luaL_error(L, "Minecraft.Noises.INoise does not have a constructor!");
        }
        ...
        static int _m_Noise(RealStatePtr L)
        {
		    try {
                ...
                Minecraft.Noises.INoise gen_to_be_invoked = (Minecraft.Noises.INoise)translator.FastGetCSObj(L, 1);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to Minecraft.Noises.INoise.Noise!");
