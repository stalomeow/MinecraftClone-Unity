...
namespace XLua.CSObjectWrap
{
    ...
    public class MinecraftConfigurationsIOrderedConfigDataWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(Minecraft.Configurations.IOrderedConfigData);
        ...
        {
            return LuaAPI.luaL_error(L, "Minecraft.Configurations.IOrderedConfigData does not have a constructor!");
        }
        ...
        static int _g_get_ID(RealStatePtr L)
        {
		    try {
                ...
                Minecraft.Configurations.IOrderedConfigData gen_to_be_invoked = (Minecraft.Configurations.IOrderedConfigData)translator.FastGetCSObj(L, 1);
