...
namespace XLua.CSObjectWrap
{
    ...
    public class MinecraftWorldWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(Minecraft.World);
            ...
            Utils.RegisterFunc(L, Utils.CLS_GETTER_IDX, "ActiveSetting", _g_get_ActiveSetting);
            
			Utils.RegisterFunc(L, Utils.CLS_SETTER_IDX, "ActiveSetting", _s_set_ActiveSetting);
        ...
        {
            return LuaAPI.luaL_error(L, "Minecraft.World does not have a constructor!");
        }
        ...
        static int _m_MarkBlockMeshDirty(RealStatePtr L)
        {
		    try {
                ...
                Minecraft.World gen_to_be_invoked = (Minecraft.World)translator.FastGetCSObj(L, 1);
        ...
        static int _g_get_Active(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			    translator.PushAny(L, Minecraft.World.Active);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _g_get_ActiveSetting(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			    translator.Push(L, Minecraft.World.ActiveSetting);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _s_set_ActiveSetting(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			    Minecraft.World.ActiveSetting = (Minecraft.WorldSetting)translator.GetObject(L, 1, typeof(Minecraft.WorldSetting));
